...
--
-- Temporary view structure for view `hospital_patient_details`
--

DROP TABLE IF EXISTS `hospital_patient_details`;
/*!50001 DROP VIEW IF EXISTS `hospital_patient_details`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `hospital_patient_details` AS SELECT 
 ...
 1 AS `surgery_notes`,
 1 AS `room_charges`,
 1 AS `surgery_charges`,
 1 AS `medicine_charges`,
 1 AS `test_charges`,
 1 AS `doctor_fees`,
 1 AS `other_charges`,
 1 AS `total_amount`,
...
--
-- Final view structure for view `hospital_patient_details`
--
...
-- Dump completed on 2025-10-24 20:49:16
